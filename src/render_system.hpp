...
class RenderSystem {
	...
	const std::array<std::string, texture_count> texture_paths = {
			...
			textures_path("green_door_1.png"),
			textures_path("green_door_2.png"),
			textures_path("green_door_3.png"),
			textures_path("green_door_4.png"),
			textures_path("green_door_5.png"),
			textures_path("green_door_6.png"),
			textures_path("green_door_7.png"),
			textures_path("green_door_8.png"),
