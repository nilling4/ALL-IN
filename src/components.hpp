...
enum class TEXTURE_ASSET_ID {
	...
	DOOR_FRAME_0 = DIAMOND_PROJECTILE + 1,
	DOOR_FRAME_1 = DOOR_FRAME_0 + 1,
	DOOR_FRAME_2 = DOOR_FRAME_1 + 1,
	DOOR_FRAME_3 = DOOR_FRAME_2 + 1,
	DOOR_FRAME_4 = DOOR_FRAME_3 + 1,
	DOOR_FRAME_5 = DOOR_FRAME_4 + 1,
	DOOR_FRAME_6 = DOOR_FRAME_5 + 1,
	DOOR_FRAME_7 = DOOR_FRAME_6 + 1,
	QUEEN_HEARTS = DOOR_FRAME_7 + 1,
...
enum class GEOMETRY_BUFFER_ID {
	...
	TRIANGLE = HEALTH_BAR + 1,
	GEOMETRY_COUNT = TRIANGLE + 1
};
